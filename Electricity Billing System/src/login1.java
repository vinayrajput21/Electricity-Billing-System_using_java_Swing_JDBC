...
public class login1 extends JFrame implements ActionListener {
    ...
    JButton old, neww ,submit,login;
    JPanel p1, p2;
    JLabel name, fathername, address, emailId, age, contact, details, meter_no;
    JTextField t1, t2, t3, t4, t5,t6,t7;
    GridBagConstraints cons;
    GridBagLayout gbag;

    login1() {
        super("Electricity Billing Department");
        setSize(800, 500);
        setLocation(400, 100);
        ...
        cons.gridx = 0;
        cons.gridy = 0;
        cons.insets = new Insets(80, 80, 10, 10);
        cons.gridwidth=1;
        gbag.setConstraints(old, cons);
        p1.add(old);
        
        cons.gridx = 0;
        cons.gridy = 1;
        cons.gridwidth=1;      
        gbag.setConstraints(neww, cons);
